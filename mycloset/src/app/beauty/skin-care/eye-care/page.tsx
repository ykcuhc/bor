...
const SUBCATEGORIES = [
  { label: 'Eye Creams & Treatments', image: 'https://picsum.photos/seed/ec-creams/600/400', href: '/beauty/skin-care/eye-care/eye-creams-treatments' },
  { label: 'Eye Masks',               image: 'https://picsum.photos/seed/ec-masks/600/400',  href: '/beauty/skin-care/eye-care/eye-masks'             },
  { label: 'Lash & Brow Regrowth',    image: 'https://picsum.photos/seed/ec-lash/600/400',   href: '/beauty/skin-care/eye-care/lash-brow-regrowth'    },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <span className="text-gray-900 font-semibold">Eye Care</span>
      </div>

      {/* Title */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 uppercase tracking-wide">Eye Care</h1>
      ...
      <div>
        <div className="flex items-baseline justify-between mb-4">
          <h2 className="text-lg sm:text-xl font-extrabold text-gray-900 uppercase tracking-wide">All Eye Care</h2>
