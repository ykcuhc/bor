...
const SUBCATEGORIES = [
  { label: 'Chargers & Cables', image: 'https://picsum.photos/seed/ea-chargers/600/400', href: '/electronics/accessories/chargers-cables' },
  { label: 'Power Banks', image: 'https://picsum.photos/seed/ea-power/600/400', href: '/electronics/accessories/power-banks' },
  { label: 'Cases & Screen Protectors', image: 'https://picsum.photos/seed/ea-cases/600/400', href: '/electronics/accessories/cases-screen-protectors' },
  { label: 'Storage Devices', image: 'https://picsum.photos/seed/ea-storage/600/400', href: '/electronics/accessories/storage-devices' },
  { label: 'Computer Accessories', image: 'https://picsum.photos/seed/ea-computer/600/400', href: '/electronics/accessories/computer-accessories' },
];

export default function ElectronicsAccessoriesPage() {
