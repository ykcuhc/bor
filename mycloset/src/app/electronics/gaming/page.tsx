...
const SUBCATEGORIES = [
  { label: 'Consoles', image: 'https://picsum.photos/seed/eg-consoles/600/400', href: '/electronics/gaming/consoles' },
  { label: 'Gaming PC', image: 'https://picsum.photos/seed/eg-pc/600/400', href: '/electronics/gaming/gaming-pc' },
  { label: 'Games', image: 'https://picsum.photos/seed/eg-games/600/400', href: '/electronics/gaming/games' },
  { label: 'Controllers', image: 'https://picsum.photos/seed/eg-ctrl/600/400', href: '/electronics/gaming/controllers' },
  { label: 'Gaming Accessories', image: 'https://picsum.photos/seed/eg-gacc/600/400', href: '/electronics/gaming/gaming-accessories' },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
      <div className="flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <span className="text-gray-900 font-semibold">Gaming</span>
      </div>
      <div>
        <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 uppercase tracking-wide">Gaming</h1>
      ...
      <div>
        <div className="flex items-baseline justify-between mb-4">
          <h2 className="text-lg sm:text-xl font-extrabold text-gray-900 uppercase tracking-wide">All Gaming</h2>
