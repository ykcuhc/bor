...
const SUBCATEGORIES = [
  { label: 'Bath Towels', image: 'https://picsum.photos/seed/be-towels/600/400', href: '/home-living/bathroom-essentials/bath-towels' },
  { label: 'Bathroom Accessories', image: 'https://picsum.photos/seed/be-access/600/400', href: '/home-living/bathroom-essentials/bathroom-accessories' },
  { label: 'Shower Accessories', image: 'https://picsum.photos/seed/be-shower/600/400', href: '/home-living/bathroom-essentials/shower-accessories' },
  { label: 'Storage & Organizers', image: 'https://picsum.photos/seed/be-storage/600/400', href: '/home-living/bathroom-essentials/storage-organizers' },
  { label: 'Bath Mats', image: 'https://picsum.photos/seed/be-mats/600/400', href: '/home-living/bathroom-essentials/bath-mats' },
];

export default function BathroomEssentialsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
      <div className="flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <span className="text-gray-900 font-semibold">Bathroom Essentials</span>
      </div>
      <div>
        <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 uppercase tracking-wide">Bathroom Essentials</h1>
      ...
      <div>
        <div className="flex items-baseline justify-between mb-4">
          <h2 className="text-lg sm:text-xl font-extrabold text-gray-900 uppercase tracking-wide">All Bathroom Essentials</h2>
