...
const SUBCATEGORIES = [
  { label: 'Living Room', image: 'https://picsum.photos/seed/fu-living/600/400', href: '/home-living/furniture/living-room' },
  { label: 'Bedroom', image: 'https://picsum.photos/seed/fu-bedroom/600/400', href: '/home-living/furniture/bedroom' },
  { label: 'Dining Room', image: 'https://picsum.photos/seed/fu-dining/600/400', href: '/home-living/furniture/dining-room' },
  { label: 'Office', image: 'https://picsum.photos/seed/fu-office/600/400', href: '/home-living/furniture/office' },
  { label: 'Outdoor', image: 'https://picsum.photos/seed/fu-outdoor/600/400', href: '/home-living/furniture/outdoor' },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
      <div className="flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <span className="text-gray-900 font-semibold">Furniture</span>
      </div>
      <div>
        <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 uppercase tracking-wide">Furniture</h1>
      ...
      <div>
        <div className="flex items-baseline justify-between mb-4">
          <h2 className="text-lg sm:text-xl font-extrabold text-gray-900 uppercase tracking-wide">All Furniture</h2>
